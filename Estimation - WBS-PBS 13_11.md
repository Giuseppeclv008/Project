...
Estimated duration: (calendar time): to be computed once again (design and requirements estimation hours were modified)
...
| &nbsp;&nbsp; Implement autenticathion section              |                                 |
| &nbsp;&nbsp; Implement CSV management                      |                                 |
| &nbsp;&nbsp; Implement order management and suggestions section |                                 |
| &nbsp;&nbsp; Implement accounting management section       |                                 |
| &nbsp;&nbsp; Integrate API for the interaction with the cash register |                                 |
| &nbsp;&nbsp; Implement sales management section            |                                 |
| &nbsp;&nbsp; Implement inventory management section        |                                 |
| &nbsp;&nbsp; Implement catalogue management section        |                                 |
| &nbsp;&nbsp; Implement DBSM                                |                                 |
| &nbsp;&nbsp; Write internet connection check logic         |                                 |
